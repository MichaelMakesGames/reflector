...
export const BLACK = "#140c1c";
export const PURPLE = "#442434";
export const DARK_BLUE = "#30346d";
export const DARK_GRAY = "#4e4a4e";
export const BROWN = "#854c30";
export const DARK_GREEN = "#346524";
export const RED = "#d04648";
export const RED_GRAY = "#757161";
export const BLUE = "#597dce";
export const ORANGE = "#d27d2c";
export const BLUE_GRAY = "#8595a1";
export const GREEN = "#6daa2c";
export const LIGHT_BROWN = "#d2aa99";
export const LIGHT_BLUE = "#6dc2ca";
export const YELLOW = "#dad45e";
export const WHITE = "#deeed6";
